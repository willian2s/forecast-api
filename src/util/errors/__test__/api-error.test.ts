...
describe('ApiError', () => {
  it('Format error with mandatory fields', () => {
  ...
  it('Format error with mandatory fields and description', () => {
  ...
  it('Format error with mandatory fields and description and documentation', () => {
    const error = ApiError.format({
      code: 404,
      message: 'User not found!',
      description: 'This error happens when there is no user created',
